...
Skill especializada para operaciones de **planning** en entornos multiagente (OpenClaw/KiloCode).

## Descripción general

Chrono Ward permite ejecutar tareas de planning con un flujo seguro, reproducible y trazable.

## Cuándo usar

- Necesitas ejecución estructurada en el dominio **planning**.
...
- Activación por triggers para escenarios de planning.
...
**Input:** "Audita y mejora el flujo de planning."
