...
Specialized skill for **planning** operations in multi-agent environments (OpenClaw/KiloCode).

## Overview

Chrono Ward helps execute planning tasks with a secure, repeatable, and audit-friendly workflow.

## When to use

- You need structured execution in the **planning** domain.
- You want reproducible outputs (plan, verification, rollback).
- You need explicit safety guardrails and operator control.

## Core capabilities

- Trigger-based activation for planning scenarios.
...
**Input:** "Audit and improve planning workflow."
