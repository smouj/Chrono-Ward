...
**Chrono Ward** es una skill especializada en **planning** para ecosistemas multiagente (OpenClaw/KiloCode), diseñada para ejecutar tareas con seguridad, trazabilidad y resultados reproducibles.

## Cuándo usarla

- Cuando la tarea pertenece al dominio de **planning**.
...
**Input:** “Necesito revisar y endurecer el flujo de planning”.
