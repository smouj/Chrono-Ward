# ⏳ Chrono Ward — Agent Runtime Architecture
...
flowchart LR
  ...
  B --> C[Threshold trigger]
  C --> D[Execution]
  D --> E[Verification]
  E --> F[Outcome report]
```

**Canonical flow:** Recurring task baseline -> Drift detect -> Threshold trigger -> Replan -> Version archive

## Core components
Temporal drift analytics, stale assumption detection, proactive replanning and history diffs.
